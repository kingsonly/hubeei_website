    ...
    return (
        <>
            ...
            <section className="max-w-full h-full relative  max-container padding-container bg-black pb-24" aria-multiselectable="false">
                <ul
                    className="flex items-center focus:border-b-4 focus:border-orange-0 py-6"
                    role="tablist"
                    ref={wrapperRef}
                >
                    <li className="flex-1" role="presentation ">
                        <button
                            className={`-mb-px font-[Raleway] inline-flex h-12 w-full items-center justify-center gap-2 whitespace-nowrap rounded-t focus:border-b-4 px-6 text-sm font-semibold tracking-wide transition duration-300 hover:stroke-orange-0  focus-visible:outline-none disabled:cursor-not-allowed ${tabSelected.currentTab === 1
                                    ? "border-orange-0 stroke-orange-0 text-orange-0    focus:border-orange-0  disabled:border-slate-500"
                                    : "justify-self-center  text-white hover:border-orange-0 hover:text-orange-0 disabled:text-slate-500"
                                }`}
                            id="tab-label-1a"
                            role="tab"
                            aria-setsize="3"
                    ...
                    <li className="flex-1" role="presentation ">
                        <button
                            className={`-mb-px font-[Raleway] inline-flex h-12 w-full items-center justify-center gap-2 whitespace-nowrap rounded-t focus:border-b-4 px-6 text-sm font-semibold tracking-wide transition duration-300 hover:stroke-orange-0  focus-visible:outline-none disabled:cursor-not-allowed ${tabSelected.currentTab === 2
                                ? "border-orange-0 stroke-orange-0 text-orange-0    focus:border-orange-0  disabled:border-slate-500"
                                : "justify-self-center  text-white hover:border-orange-0 hover:text-orange-0 disabled:text-slate-500"
                                }`}
                            id="tab-label-2a"
                    ...
                    <li className="flex-1" role="presentation ">
                        <button
                            className={`-mb-px font-[Raleway] inline-flex h-12 w-full items-center justify-center gap-2 whitespace-nowrap rounded-t focus:border-b-4 px-6 text-sm font-semibold tracking-wide transition duration-300 hover:stroke-orange-0  focus-visible:outline-none disabled:cursor-not-allowed ${tabSelected.currentTab === 3
                                ? "border-orange-0 stroke-orange-0 text-orange-0    focus:border-orange-0  disabled:border-slate-500"
                                : "justify-self-center  text-white hover:border-orange-0 hover:text-orange-0 disabled:text-slate-500"
                                }`}
                            id="tab-label-3a"
...
<img src={img1} className="object-contain "   />
                    ...
                    >
                        <div className="flex flexStart flex-col-reverse lg:flex-row gap-11 lg:gap-20">
                            ...
                            <div>
                                <img src={img3} className="object-contain aspect-auto" />
                            </div>
